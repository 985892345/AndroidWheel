package com.g985892345.extensions.rxpermissions
...
import com.g985892345.extensions.android.getSp
...
private fun performRequestPermission(
  ...
  val sp = context.getSp(permissionsRequired.toString())
  var isNeverShow = sp.getBoolean("isNeverShow", false)
  if (isNeverShow) {
